...
/** Fork-owned late-bind seams passed as one immutable product-creation dependency. */
public record NereusKafkaForkRuntimeBridges(
        KafkaRecoveryStateFactory recoveryStateFactory,
        NereusKafkaOwnedPartitionSourceBridge ownedPartitions
) {
    public NereusKafkaForkRuntimeBridges {
