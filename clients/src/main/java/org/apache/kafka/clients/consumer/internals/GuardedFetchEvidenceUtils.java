...
/** Deterministic digest helper for guarded Fetch response evidence. */
final class GuardedFetchEvidenceUtils {
    private GuardedFetchEvidenceUtils() {
    }

    static byte[] sha256(final ByteBuffer source) {
