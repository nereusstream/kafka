...
/** Immutable resource identity required by a guarded single-partition fetch. */
public final class ConsumerResourceGuard {
    private final String authenticatedClusterId;
    private final String canonicalTopic;
    private final Uuid expectedTopicId;
    private final int partition;

    public ConsumerResourceGuard(final String authenticatedClusterId, final String canonicalTopic,
        ...
        if (Uuid.ZERO_UUID.equals(expectedTopicId) || partition < 0) {
            throw new IllegalArgumentException("invalid Consumer resource guard");
        }
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof ConsumerResourceGuard)) {
            return false;
        }
        ConsumerResourceGuard that = (ConsumerResourceGuard) other;
    ...
    public String toString() {
        return "ConsumerResourceGuard{authenticatedClusterId='" + authenticatedClusterId
